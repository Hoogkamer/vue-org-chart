...
const INPUT_DATA = window.INPUT_DATA || {}
const UINAMES = window.UINAMES || {}
const UPDATED_ON = window.UPDATED_ON || ""
...
function departmentIsVisible(dept) {
  ...
  if (!el || !pr) return { isVissible: false, moveTo: { x: 0, y: 0 } }
